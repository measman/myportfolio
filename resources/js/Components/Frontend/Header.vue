...
<template>
    <nav class="bg-light-primary border-gray-200 dark:bg-dark-primary">
        ...
        >
            ...
            >
                <ul
                    class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-light-tail-500 dark:border-dark-navy-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0"
                >
                    <li>
                        <a
                            href="#"
